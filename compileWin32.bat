...
echo /____________________________________________________________\
 	 @wpp386 -DWIN32 /6s main.cpp ^
 	 -Fo="../EXT/main" 2>&1 | findstr /V /C:"Open Watcom" /C:"Portions" /C:"See"
echo ______________________________________________________________
echo \____________________________________________________________/
echo.
echo.
echo.
REM echo  __________(engine.CPP)________________________________________
REM echo /____________________________________________________________\
REM 	 @wpp386 -DWIN32 /6s engine.cpp ^
REM  	 -Fo="../EXT/main" 2>&1 | findstr /V /C:"Open Watcom" /C:"Portions" /C:"See"
REM echo ______________________________________________________________
REM echo \____________________________________________________________/
echo.
echo.
echo.
...
echo /____________________________________________________________\
	 @wpp386 /6s glad.c ^
	 -Fo="../EXT/glad" 2>&1 | findstr /V /C:"Open Watcom" /C:"Portions" /C:"See"
echo ______________________________________________________________
echo \____________________________________________________________/
echo.
echo.
