...
GVector3 matrix4_transform(GMatrix4 self, GVector3 vector);

GMatrix4 matrix4_translation(float x, float y, float z);

GVector3 matrix4_get_basis(const GMatrix4 self, int basis);
...
int matrix4_project(const GMatrix4  projection, const GMatrix4  modelview, const int* viewport, const GVector3* object, GVector3* window);

int matrix4_unproject(const GMatrix4  projection, const GMatrix4  modelview, const int* viewport, const GVector3* window, GVector3* object);
